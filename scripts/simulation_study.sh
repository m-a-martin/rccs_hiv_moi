...
Rscript scripts/run_stan.R \
	...
	--stan stan/base_deep-phyloMI.stan \
...
# to do need to get this to work :(
Rscript scripts/run_stan.R \
...
for delta in 0 0.05 0.10 0.20; do
	...
	mkdir -p stan/models/sensitivity
	# 3A. simulate
...
Rscript scripts/run_stan.R \
	...
	--seqDesignMatrix "scaled_log10_vl_obs" \
	--multivariateRiskRatios "risk_factor_MI_1=='1':risk_factor_MI_1=='0'"
