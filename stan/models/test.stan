...
data{
  ...
  matrix[N_ind, 5] X_mi; // mi input data 
}
...
transformed parameters{
  ...
  logit_prob_mi_coeffs = [mi_beta1[1],mi_beta1[2],mi_beta2,mi_beta3[1],mi_beta3[2]]';
  matrix[2029, 5] X_mi_imputed = X_mi[,];
