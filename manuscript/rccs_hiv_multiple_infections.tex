...
\end{tabular}
\begin{flushleft} {\bf Parameter estimates for full model fit to deep-sequence data from \var{empirical_comm_n_participant_visits} RCCS participants living with viremic HIV with deep-sequencing protocol as a putative risk factor for harboring multiple infections.} ESS = effective sample size. HPD = highest posterior density. 
\end{flushleft}
%\end{adjustwidth}
\end{table}
\newpage
...
Parameter & Prior & Median (95\% HPD) & Bulk ESS & Tail ESS & $\hat{R}$ \\ \thickhline
$\alpha_0$ & Normal(0,$2^2$) &
  \var{empirical_seq_tech_comm_fit_logit_prob_seq_baseline_median} 
    (\var{empirical_seq_tech_comm_fit_logit_prob_seq_baseline_lower}, \var{empirical_seq_tech_comm_fit_logit_prob_seq_baseline_upper}) & 
  \var{empirical_seq_tech_comm_fit_logit_prob_seq_baseline_bulk_ess} & 
  \var{empirical_seq_tech_comm_fit_logit_prob_seq_baseline_tail_ess} & 
  \var{empirical_seq_tech_comm_fit_logit_prob_seq_baseline_rhat} \\ \hline
$\alpha^{bait}$ & Normal(0,$2^2$) &
  \var{empirical_seq_tech_comm_fit_logit_prob_seq_coeffs1_median}
    (\var{empirical_seq_tech_comm_fit_logit_prob_seq_coeffs1_lower}, \var{empirical_seq_tech_comm_fit_logit_prob_seq_coeffs1_upper}) & 
  \var{empirical_seq_tech_comm_fit_logit_prob_seq_coeffs1_bulk_ess} & 
  \var{empirical_seq_tech_comm_fit_logit_prob_seq_coeffs1_tail_ess} & 
  \var{empirical_seq_tech_comm_fit_logit_prob_seq_coeffs1_rhat} \\ \hline
$\alpha^{amplicon-vl}$ & Normal(0,$2^2$) &
  \var{empirical_seq_tech_comm_fit_logit_prob_seq_coeffs2_median}
    (\var{empirical_seq_tech_comm_fit_logit_prob_seq_coeffs2_lower}, \var{empirical_seq_tech_comm_fit_logit_prob_seq_coeffs2_upper}) & 
  \var{empirical_seq_tech_comm_fit_logit_prob_seq_coeffs2_bulk_ess} & 
  \var{empirical_seq_tech_comm_fit_logit_prob_seq_coeffs2_tail_ess} & 
  \var{empirical_seq_tech_comm_fit_logit_prob_seq_coeffs2_rhat} \\ \hline
$\alpha^{bait-vl}$ & Normal(0,$2^2$) &
  \var{empirical_seq_tech_comm_fit_logit_prob_seq_coeffs3_median}
    (\var{empirical_seq_tech_comm_fit_logit_prob_seq_coeffs3_lower}, \var{empirical_seq_tech_comm_fit_logit_prob_seq_coeffs3_upper}) & 
  \var{empirical_seq_tech_comm_fit_logit_prob_seq_coeffs3_bulk_ess} & 
  \var{empirical_seq_tech_comm_fit_logit_prob_seq_coeffs3_tail_ess} & 
  \var{empirical_seq_tech_comm_fit_logit_prob_seq_coeffs3_rhat} \\ \hline
$\sigma_\alpha$ & Half-Cauchy(0,1) & 
  \var{empirical_seq_tech_comm_fit_logit_prob_seq_ind_sd_median}
    (\var{empirical_seq_tech_comm_fit_logit_prob_seq_ind_sd_lower}, \var{empirical_seq_tech_comm_fit_logit_prob_seq_ind_sd_upper}) & 
  \var{empirical_seq_tech_comm_fit_logit_prob_seq_ind_sd_bulk_ess} & 
  \var{empirical_seq_tech_comm_fit_logit_prob_seq_ind_sd_tail_ess} &
  \var{empirical_seq_tech_comm_fit_logit_prob_seq_ind_sd_rhat} \\ \hline
$\delta_0$ & Normal(0,$3.16^2$) &
  \var{empirical_seq_tech_comm_fit_logit_prob_MI_median}
    (\var{empirical_seq_tech_comm_fit_logit_prob_MI_lower}, \var{empirical_seq_tech_comm_fit_logit_prob_MI_upper}) & 
  \var{empirical_seq_tech_comm_fit_logit_prob_MI_bulk_ess} & 
  \var{empirical_seq_tech_comm_fit_logit_prob_MI_tail_ess} & 
  \var{empirical_seq_tech_comm_fit_logit_prob_MI_rhat} \\ \hline
$\beta_1$ (fishing) & Normal(0,1) &  
  \var{empirical_seq_tech_comm_fit_logit_prob_MI_coeffs1_median}
    (\var{empirical_seq_tech_comm_fit_logit_prob_MI_coeffs1_lower}, \var{empirical_seq_tech_comm_fit_logit_prob_MI_coeffs1_upper}) & 
  \var{empirical_seq_tech_comm_fit_logit_prob_MI_coeffs1_bulk_ess} & 
  \var{empirical_seq_tech_comm_fit_logit_prob_MI_coeffs1_tail_ess} & 
  \var{empirical_seq_tech_comm_fit_logit_prob_MI_coeffs1_rhat} \\ \hline
$\beta_2$ (bait) & Normal(0,1) &  
  \var{empirical_seq_tech_comm_fit_logit_prob_MI_coeffs2_median}
    (\var{empirical_seq_tech_comm_fit_logit_prob_MI_coeffs2_lower}, \var{empirical_seq_tech_comm_fit_logit_prob_MI_coeffs2_upper}) & 
  \var{empirical_seq_tech_comm_fit_logit_prob_MI_coeffs2_bulk_ess} & 
  \var{empirical_seq_tech_comm_fit_logit_prob_MI_coeffs2_tail_ess} & 
  \var{empirical_seq_tech_comm_fit_logit_prob_MI_coeffs2_rhat} \\ \hline
logit($\lambda$) & Normal(0,1) & 
  \var{empirical_seq_tech_comm_fit_logit_prob_MI_fnr_median}
    (\var{empirical_seq_tech_comm_fit_logit_prob_MI_fnr_lower}, \var{empirical_seq_tech_comm_fit_logit_prob_MI_fnr_upper}) & 
  \var{empirical_seq_tech_comm_fit_logit_prob_MI_fnr_bulk_ess} & 
  \var{empirical_seq_tech_comm_fit_logit_prob_MI_fnr_tail_ess} & 
  \var{empirical_seq_tech_comm_fit_logit_prob_MI_fnr_rhat} \\ \hline
logit($\epsilon$) & Normal(0,1) & 
  \var{empirical_seq_tech_comm_fit_logit_prob_MI_fpr_median}
    (\var{empirical_seq_tech_comm_fit_logit_prob_MI_fpr_lower}, \var{empirical_seq_tech_comm_fit_logit_prob_MI_fpr_upper}) & 
  \var{empirical_seq_tech_comm_fit_logit_prob_MI_fpr_bulk_ess} & 
  \var{empirical_seq_tech_comm_fit_logit_prob_MI_fpr_tail_ess} & 
  \var{empirical_seq_tech_comm_fit_logit_prob_MI_fpr_rhat} \\ \hline
\end{tabular}
\begin{flushleft} {\bf Parameter estimates for full model fit to deep-sequence data from \var{empirical_comm_n_participant_visits} RCCS participants living with viremic HIV with community type and deep-sequencing protocol as putative risk factors for harboring multiple infections} ESS = effective sample size. HPD = highest posterior density. 
\end{flushleft}
%\end{adjustwidth}
\end{table}
\newpage
...
$\beta_2$ (inland:sexpever) & Normal(0,1) & 
...
$\beta_3$ (fishing:sexpever) & Normal(0,1) & 
...
\end{tabular}
\begin{flushleft} {\bf Parameter estimates for full model fit to deep-sequence data from \var{empirical_sexpever_men_n_participant_visits} men who participated in the RCCS living with viremic HIV with community type and number of lifetime sex partners as putative risk factors for harboring multiple infections adjusted for deep-sequencing protocol..} ESS = effective sample size. HPD = highest posterior density. 
\end{flushleft}
%\end{adjustwidth}
\end{table} 
...
\end{tabular}
\begin{flushleft} {\bf Parameter estimates for full model fit to deep-sequence data from \var{empirical_var_select_n_participant_visits} RCCS participants living with viremic HIV with putative risk factors for harboring multiple infection and Bayesian shrinkage priors.} ESS = effective sample size. HPD = highest posterior density. 
\end{flushleft}
%\end{adjustwidth}
\end{table} 
\newpage
