...
$\alpha_0$&Normal(0,$2^2$)&\var{empirical_comm_seq_fit_logit_prob_seq_baseline_median} 
    (\var{empirical_comm_seq_fit_logit_prob_seq_baseline_lower}, \var{empirical_comm_seq_fit_logit_prob_seq_baseline_upper}) & 
  \var{empirical_comm_seq_fit_logit_prob_seq_baseline_bulk_ess} & 
  \var{empirical_comm_seq_fit_logit_prob_seq_baseline_tail_ess} & 
  \var{empirical_comm_seq_fit_logit_prob_seq_baseline_rhat} \\ \hline
$\alpha_1$ (amplicon) & $2\times\text{stz-MVN}_1(0,1)$ &
  \var{empirical_comm_seq_fit_logit_prob_seq_coeffs1_median}
    (\var{empirical_comm_seq_fit_logit_prob_seq_coeffs1_lower}, \var{empirical_comm_seq_fit_logit_prob_seq_coeffs1_upper}) & 
  \var{empirical_comm_seq_fit_logit_prob_seq_coeffs1_bulk_ess} & 
  \var{empirical_comm_seq_fit_logit_prob_seq_coeffs1_tail_ess} & 
  \var{empirical_comm_seq_fit_logit_prob_seq_coeffs1_rhat} \\ \hline
$\alpha_2$ (bait-capture) & $2\times\text{stz-MVN}_1(0,1)$ &
  \var{empirical_comm_seq_fit_logit_prob_seq_coeffs2_median}
    (\var{empirical_comm_seq_fit_logit_prob_seq_coeffs2_lower}, \var{empirical_comm_seq_fit_logit_prob_seq_coeffs2_upper}) & 
  \var{empirical_comm_seq_fit_logit_prob_seq_coeffs2_bulk_ess} & 
  \var{empirical_comm_seq_fit_logit_prob_seq_coeffs2_tail_ess} & 
  \var{empirical_comm_seq_fit_logit_prob_seq_coeffs2_rhat} \\ \hline
$\alpha_3$ (log$_{10}$ copies/mL) & Normal(0,$2^2$) &
  \var{empirical_comm_seq_fit_logit_prob_seq_coeffs3_median}
    (\var{empirical_comm_seq_fit_logit_prob_seq_coeffs3_lower}, \var{empirical_comm_seq_fit_logit_prob_seq_coeffs3_upper}) & 
  \var{empirical_comm_seq_fit_logit_prob_seq_coeffs3_bulk_ess} & 
  \var{empirical_comm_seq_fit_logit_prob_seq_coeffs3_tail_ess} & 
  \var{empirical_comm_seq_fit_logit_prob_seq_coeffs3_rhat} \\ \hline
$\alpha_4$ (amplicon $\times$ log$_{10}$ copies/mL) & $2\times\text{stz-MVN}_2(0,1)$ &
  \var{empirical_comm_seq_fit_logit_prob_seq_coeffs4_median}
    (\var{empirical_comm_seq_fit_logit_prob_seq_coeffs4_lower}, \var{empirical_comm_seq_fit_logit_prob_seq_coeffs4_upper}) & 
...
$\beta_4$ (bait-capture) & $\text{stz-MVN}_4(0,1)$ & 
  \var{empirical_comm_seq_fit_logit_prob_mi_coeffs4_median}
    (\var{empirical_comm_seq_fit_logit_prob_mi_coeffs4_lower}, \var{empirical_comm_seq_fit_logit_prob_mi_coeffs4_upper}) & 
  \var{empirical_comm_seq_fit_logit_prob_mi_coeffs4_bulk_ess} & 
  \var{empirical_comm_seq_fit_logit_prob_mi_coeffs4_tail_ess} & 
  \var{empirical_comm_seq_fit_logit_prob_mi_coeffs4_rhat} \\ \hline
logit($\lambda$) & Normal(0,1)[,2.2] & 
  \var{empirical_comm_seq_fit_logit_prob_mi_fnr_median}
    (\var{empirical_comm_seq_fit_logit_prob_mi_fnr_lower}, \var{empirical_comm_seq_fit_logit_prob_mi_fnr_upper}) & 
  \var{empirical_comm_seq_fit_logit_prob_mi_fnr_bulk_ess} & 
  \var{empirical_comm_seq_fit_logit_prob_mi_fnr_tail_ess} & 
  \var{empirical_comm_seq_fit_logit_prob_mi_fnr_rhat} \\ \hline
logit($\epsilon$) & Normal(0,1) & 
  \var{empirical_comm_seq_fit_logit_prob_mi_fpr_median}
    (\var{empirical_comm_seq_fit_logit_prob_mi_fpr_lower}, \var{empirical_comm_seq_fit_logit_prob_mi_fpr_upper}) & 
  \var{empirical_comm_seq_fit_logit_prob_mi_fpr_bulk_ess} & 
  \var{empirical_comm_seq_fit_logit_prob_mi_fpr_tail_ess} & 
  \var{empirical_comm_seq_fit_logit_prob_mi_fpr_rhat} \\ \hline
\end{tabular}
\end{table}
\end{document}