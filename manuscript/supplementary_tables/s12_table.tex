...
$\alpha_0$&Normal(0,$2^2$)&\var{empirical_seq_fit_logit_prob_seq_baseline_median} 
...
$\alpha_4$ (amplicon $\times$ log$_{10}$ copies/mL) & $2\times\text{stz-MVN}_2(0,1)$ &
  \var{empirical_seq_fit_logit_prob_seq_coeffs4_median}
    (\var{empirical_seq_fit_logit_prob_seq_coeffs4_lower}, \var{empirical_seq_fit_logit_prob_seq_coeffs4_upper}) & 
  \var{empirical_seq_fit_logit_prob_seq_coeffs4_bulk_ess} & 
...
$\beta_2$ (bait-capture) & $\text{stz-MVN}_3(0,1)$ & 
  \var{empirical_seq_fit_logit_prob_mi_coeffs2_median}
    (\var{empirical_seq_fit_logit_prob_mi_coeffs2_lower}, \var{empirical_seq_fit_logit_prob_mi_coeffs2_upper}) & 
  \var{empirical_seq_fit_logit_prob_mi_coeffs2_bulk_ess} & 
  \var{empirical_seq_fit_logit_prob_mi_coeffs2_tail_ess} & 
  \var{empirical_seq_fit_logit_prob_mi_coeffs2_rhat} \\ \hline
