...
$\alpha_0$&Normal(0,$2^2$)&\var{empirical_sexpever_men_complete_fit_logit_prob_seq_baseline_median} 
...
$\alpha_4$ (amplicon $\times$ log$_{10}$ copies/mL) & $2\times\text{stz-MVN}_2(0,1)$ &
  \var{empirical_sexpever_men_complete_fit_logit_prob_seq_coeffs4_median}
    (\var{empirical_sexpever_men_complete_fit_logit_prob_seq_coeffs4_lower}, \var{empirical_sexpever_men_complete_fit_logit_prob_seq_coeffs4_upper}) & 
  \var{empirical_sexpever_men_complete_fit_logit_prob_seq_coeffs4_bulk_ess} & 
  \var{empirical_sexpever_men_complete_fit_logit_prob_seq_coeffs4_tail_ess} & 
  \var{empirical_sexpever_men_complete_fit_logit_prob_seq_coeffs4_rhat} \\ \hline
$\alpha_5$ (bait-capture $\times$ log$_{10}$ copies/mL) &  $2\times\text{stz-MVN}_2(0,1)$ &
  \var{empirical_sexpever_men_complete_fit_logit_prob_seq_coeffs5_median}
    (\var{empirical_sexpever_men_complete_fit_logit_prob_seq_coeffs5_lower}, \var{empirical_sexpever_men_complete_fit_logit_prob_seq_coeffs5_upper}) & 
  \var{empirical_sexpever_men_complete_fit_logit_prob_seq_coeffs5_bulk_ess} & 
  \var{empirical_sexpever_men_complete_fit_logit_prob_seq_coeffs5_tail_ess} & 
  \var{empirical_sexpever_men_complete_fit_logit_prob_seq_coeffs5_rhat} \\ \hline
...
$\delta_0$ & Normal(0,$3.16^2$) &
  \var{empirical_sexpever_men_complete_fit_logit_prob_mi_baseline_median}
    (\var{empirical_sexpever_men_complete_fit_logit_prob_mi_baseline_lower}, \var{empirical_sexpever_men_complete_fit_logit_prob_mi_baseline_upper}) & 
  \var{empirical_sexpever_men_complete_fit_logit_prob_mi_baseline_bulk_ess} & 
  \var{empirical_sexpever_men_complete_fit_logit_prob_mi_baseline_tail_ess} & 
  \var{empirical_sexpever_men_complete_fit_logit_prob_mi_baseline_rhat} \\ \hline
...
$\beta_4$ (fishing $\times$ sexpever) & $\text{stz-MVN}_4(0,1)$ & 
...
$\beta_5$ (inland $\times$ sexpever) & $\text{stz-MVN}_4(0,1)$& 
  \var{empirical_sexpever_men_complete_fit_logit_prob_mi_coeffs5_median}
    (\var{empirical_sexpever_men_complete_fit_logit_prob_mi_coeffs5_lower}, \var{empirical_sexpever_men_complete_fit_logit_prob_mi_coeffs5_upper}) & 
  \var{empirical_sexpever_men_complete_fit_logit_prob_mi_coeffs5_bulk_ess} & 
  \var{empirical_sexpever_men_complete_fit_logit_prob_mi_coeffs5_tail_ess} & 
  \var{empirical_sexpever_men_complete_fit_logit_prob_mi_coeffs5_rhat} \\ \hline
